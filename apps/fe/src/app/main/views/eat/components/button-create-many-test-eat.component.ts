...
@Component({
  selector: 'app-button-create-many-test-eat',
  template: `
...
export class ButtonCreateManyTestEatComponent implements OnInit {
  ...
  onCreateMany(values: Eat[]): void {
    ...
    this.store$.dispatch(EatStoreActions.CreateManyRequest({items}));
  }
