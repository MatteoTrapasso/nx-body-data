...
@Component({
  selector: 'app-button-create-many-test-eat-daily',
  template: `
...
export class ButtonCreateManyTestEatDailyComponent implements OnInit {
  ...
  onCreateMany(values: EatDaily[]): void {
    ...
    this.store$.dispatch(EatDailyStoreActions.CreateManyRequest({items}));
  }
